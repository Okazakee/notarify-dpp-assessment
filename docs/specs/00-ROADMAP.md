...
Stages 0–3 and Stages 4.1–4.4 are complete. Stages 4.1–4.3 are merged into `main`; Stage 4.4 is merged into `main`. Stage 2 delivered the authentication and authorization foundation; the Users and Settings flows remain required work and are scheduled in Stage 6 rather than assumed complete.
