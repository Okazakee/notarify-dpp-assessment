...
Stages 0–3, Stages 4.1–4.6 and Stage 5 are complete. Stages 4.1–4.6 and Stage 5 are merged into `main`. Stage 2 delivered the authentication and authorization foundation; the Users and Settings flows remain required work and are scheduled in Stage 6 rather than assumed complete.
