...
| 9 | Analytics and audit tables unchanged across the journey | PASS |
| 10 | Product-list Stage 4 behavior for the accepted product (draft identity, cover, publication actions, honest Total Views) | PASS |
...
| QR download serves stored bytes and records nothing | 4.2 | acceptance #6/#9; `public-passport.e2e-spec.ts` | PASS | no |
...
| Product-list cover, status, QR state, publication actions; drafts show no broken public action | 4.4 | acceptance #10; `e2e/passports.spec.ts` | PASS | no |
